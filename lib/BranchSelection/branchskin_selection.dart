...
class BranchSkinSelectionPage extends StatefulWidget {
  const BranchSkinSelectionPage({Key? key}) : super(key: key);

  @override
  _BranchSkinSelectionPageState createState() => _BranchSkinSelectionPageState();
}

class _BranchSkinSelectionPageState extends State<BranchSkinSelectionPage> {
  ...
  Future<void> navigateToSchedule() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BranchSkinServicesPage(
