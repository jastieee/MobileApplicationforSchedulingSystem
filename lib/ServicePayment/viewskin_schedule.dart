...
// The original BranchSkinServicesPage
class BranchSkinServicesPage extends StatefulWidget {
  final String branchName;
  final String branchCode; // This is the actual branch code

  const BranchSkinServicesPage({
    Key? key,
  ...
  @override
  _BranchSkinServicesPage createState() => _BranchSkinServicesPage();
}

class _BranchSkinServicesPage extends State<BranchSkinServicesPage> {
  ...
  Future<void> fetchBranchServices() async {
    try {
      final response = await http.post(
        Uri.parse('https://membership.ndasphilsinc.com/skin_schedules.php'),
      ...
      body: isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'There are currently no skin services\navailable at this branch.',
              style: TextStyle(
                color: Colors.white54,
                fontSize: 14,
              ),
